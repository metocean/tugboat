...
module.exports = function(container, service, image) {
  var binding, binding2, e, found, item, name, output, port, source, sourceCmd, sourceout, target, targetCmd, targetout, term, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
  ...
  for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
    ...
    if (image.inspect.ContainerConfig.Env != null) {
      found = image.inspect.ContainerConfig.Env.filter(function(e) {
        return e === item;
      }).length !== 0;
    }
    if (!found) {
  ...
  if (output.length !== source.Config.Env.length) {
    console.log(output);
