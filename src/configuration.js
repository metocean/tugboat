...
var TUGBOATFormatException, isboolean, isnumber, isobjectofstringsornull, isrestartpolicy, isscripts, isstring, isstringarray, parse_port, resolve, template, validation,
...
module.exports = function(groupname, services, path, cb) {
  ...
  for (name in services) {
    ...
    if (config.scripts != null) {
      _ref1 = config.scripts;
      for (trigger in _ref1) {
        filename = _ref1[trigger];
  ...
  for (name in services) {
    ...
    services[name] = {
      ...
      params: {
        Image: config.image,
        Cmd: (_ref7 = config.command) != null ? _ref7 : null,
        User: (_ref8 = config.user) != null ? _ref8 : '',
        Memory: (_ref9 = config.mem_limit) != null ? _ref9 : 0,
        Hostname: (_ref10 = config.hostname) != null ? _ref10 : null,
        Domainname: (_ref11 = config.domainname) != null ? _ref11 : null,
        Entrypoint: (_ref12 = config.entrypoint) != null ? _ref12 : null,
        WorkingDir: (_ref13 = config.working_dir) != null ? _ref13 : '',
        Env: config.environment,
        ExposedPorts: (_ref14 = config.expose) != null ? _ref14 : null,
        HostConfig: {
          Binds: (_ref15 = config.volumes) != null ? _ref15 : null,
          Links: (_ref16 = config.links) != null ? _ref16 : null,
          Dns: (_ref17 = config.dns) != null ? _ref17 : null,
          NetworkMode: (_ref18 = config.net) != null ? _ref18 : '',
          Privileged: (_ref19 = config.privileged) != null ? _ref19 : false,
          PortBindings: (_ref20 = config.ports) != null ? _ref20 : null,
          RestartPolicy: (_ref21 = config.restart) != null ? _ref21 : {
            Name: ''
          }
        }
      }
