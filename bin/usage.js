...
commands = {
  ...
  logs: require('./logs'),
  exec: require('./exec'),
  build: function(tugboat, groupname, servicenames) {
    return build(tugboat, groupname, servicenames, true);
  },
  rebuild: function(tugboat, groupname, servicenames) {
    return build(tugboat, groupname, servicenames, false);
  }
};
...
cmds = {
  ...
  build: function() {
    return commands.build(tugboat, args[0], args.slice(1));
  },
  rebuild: function() {
    return commands.rebuild(tugboat, args[0], args.slice(1));
  },
  pull: function() {
